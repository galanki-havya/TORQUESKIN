...
const Reviews = () => {
  ...
  return (
    ...
    >
      <div className="min-h-screen w-full bg-gradient-to-b from-black/30 via-transparent to-black/50 pt-32 pb-20 px-6 backdrop-blur-[0.5px]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            ...
            <div className="lg:col-span-4 space-y-10 lg:sticky lg:top-32">
              <div className="space-y-4">
                <div className="flex items-center gap-3 text-[#d4af37]">
                  <Award size={18} />
                  <span className="text-[10px] font-black uppercase tracking-[0.8em]">Feynlab Certified</span>
                </div>
                <h1 className="text-7xl md:text-8xl font-black italic uppercase tracking-tighter leading-[0.85] drop-shadow-2xl">
                  CLIENT<br />
                  <span className="text-[#d4af37] text-outline">VOICES.</span>
                </h1>
              </div>

              <div className="space-y-6 border-l border-[#d4af37]/40 pl-6">
                <p className="text-white text-sm leading-relaxed font-semibold drop-shadow-md">
                ...
                <div className="flex items-center gap-4 text-[#d4af37] bg-black/50 p-3 rounded-sm border border-white/10 w-fit backdrop-blur-md">
                   ...
                   <span className="text-xl font-black italic">4.6 / 5.0</span>
                </div>
              </div>
              ...
              <a 
                ...
                target="_blank" 
                rel="noreferrer"
                className="group flex items-center justify-between px-8 py-5 bg-[#d4af37] text-black text-[10px] font-black uppercase tracking-[0.3em] hover:bg-white transition-all duration-500 shadow-2xl"
              >
            ...
            <div className="lg:col-span-8">
              <div className="relative w-full rounded-sm overflow-hidden">
                <div className="relative z-10 bg-black/5 backdrop-blur-md border border-white/10 p-2 md:p-6 rounded-lg">
                  <div 
                    className="elfsight-app-7a6ed715-5bc4-48d8-91d3-0adf83256b6c" 
                  ></div>
                </div>
                <Quote className="absolute -bottom-10 -right-10 text-white/10 pointer-events-none" size={240} />
              </div>
            </div>
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        .text-outline { -webkit-text-stroke: 1.5px rgba(212, 175, 55, 0.8); color: transparent; }
